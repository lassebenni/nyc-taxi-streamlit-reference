...
### Chapter 5 solution · Finished dashboard
...
You are on **`chapter-5-solution`**: the complete finished dashboard, all panels plus the sidebar borough filter.

Read it as the full reference for the week, or clone it as a starting point. This is the repo's default branch.
