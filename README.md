...
You are on **`practice-kpi-metrics-solution`**: the reference solution for the KPI-tiles exercise. Compare it against your own attempt on `practice-kpi-metrics`.
...
```bash
git switch practice-kpi-metrics-solution
